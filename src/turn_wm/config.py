...
selects the `model`; the model config nests its sub-modules, encoder
included, each naming its class with `_target_` and interpolating the shared
sizes. `turn_wm.models.build.build_model`
